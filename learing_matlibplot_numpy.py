...
im=ax[0,0].imshow(mainPhase,label='mainPhase',cmap='jet',vmin=0,vmax=500)
plt.colorbar(im,ax=ax[0,0])
ax[0,0].set(xlim=[0,79],ylim=[0,59],title="mainPhase",xlabel="Pixels",ylabel="Pixels")
im=ax[0,1].imshow(DepthAve[:,:,3],label='secondPhase',cmap='jet',vmin=0,vmax=900)
plt.colorbar(im,ax=ax[0,1])
ax[0,1].set(xlim=[0,79],ylim=[0,59],title="secondPhase",xlabel="Pixels",ylabel="Pixels")
...
ax.bar(index, mean, color = '#539caf', align = 'center') 
